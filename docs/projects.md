...
<!-- BEGIN SEARCHABLE PIPELINE CONTENT -->
...
**modr Pipeline**: An awesome Oxford Nanopore Pipeline for direct RNA-sequencing. 
This Python Snakemake workflow focuses on: alternative-splicing-analysis, bioinformatics, differential-expression-analysis, direct-rna-sequencing, known-transcripts, novel-transcripts, oxford-nanopore, pipeline, polya-tail-length-estimation, quality-control, rna-editing, rna-modifications, singularity, snakemake-pipeline, transcriptomics. 
GitHub repository with 6 stars and 1 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.

**iso-seek Pipeline**: An awesome pipeline for processing bulk PacBio transcriptomics data generated with ISO-seq and MAS-seq.. 
This Python Snakemake workflow focuses on: iso-seq, long-read-sequencing, mas-seq, pacbio-sequencing, singularity, snakemake. 
...
This Python Snakemake workflow focuses on: mature-mirna, micro-rna, micro-rna-expression, mirdeep2, mirna, mirna-seq, singularity, snakemake. 
GitHub repository with 2 stars and 1 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.

**metavirs Pipeline**: Viral Metagenomics Assembly and Annotation Pipeline. 
This Python Snakemake workflow focuses on: annotation, assembly, classification, pathogen-surveillance, pipeline, quality-control, singularity, snakemake, viral-metagenomics. 
GitHub repository with 6 stars and 1 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.

**nanite Pipeline**: A streamlined Oxford Nanopore Viral Metagenomics Pipeline . 
This Python Snakemake workflow focuses on: annotation, assembly, classification, pathogen-surveillance, pipeline, singularity, slim, snakemake, viral-metagenomics. 
...
**space-seek Pipeline**: Spatial-sequencing: The final frontier. These are the voyages of the 10x Visium pipeline, space-seek.. 
This Python Snakemake workflow focuses on: 10xgenomics, pipeline, single-cell, singularity, snakemake, visium-hd. 
GitHub repository with 1 stars and 0 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.
...
This Python Snakemake workflow focuses on: mendelian-randomization, pipeline, snakemake. 
GitHub repository with 2 stars and 1 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.

**scErvx Pipeline**: Endogenous Retrovirus Expression Pipeline for Human and Mouse for use with data from 10x genomics (bam files). 
This Python Snakemake workflow focuses on: endogenous-retrovirus-expression, single-cell-rna-seq. 
GitHub repository with 1 stars and 0 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.
...
**HiIP Pipeline**: An awesome Hi-C + ChIP (HiChIP) sequencing pipeline.. 
This Python Snakemake workflow focuses on: chip-seq, hi-c, hichip, pipeline, singularity, snakemake. 
GitHub repository with 0 stars and 0 forks. 
Technologies: Snakemake, Python, bioinformatics, genomics, computational biology.
...
[:material-github: Visit OpenOmics on GitHub](https://github.com/OpenOmics){ .md-button .md-button--primary }
